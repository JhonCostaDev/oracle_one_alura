USE `insight_places`;
DROP procedure IF EXISTS `insight_places`.`novoAluguel_9`;
DELIMITER $$
CREATE DEFINER=`root`@`%` PROCEDURE `novoAluguel_9`(
...
BEGIN
    ...
    CASE varNumClientes			-- Inicio CASE
    -- Condicional IF que testa se existe mais de um cliente com o mesmo nome
    WHEN 0 THEN		-- não registra aluguel se o cliente não estiver na base.
	...
	WHEN 1 THEN	    -- Cliente único, registra o aluguel
...
CALL novoAluguel_9('10007','Victorino Vila','8635','2023-03-30','2023-04-04',40);

CALL novoAluguel_9('10007','Júlia Pires','8635','2023-03-30','2023-04-04',40);

CALL novoAluguel_9('10007','Luana Moura','8635','2023-03-30','2023-04-04',40);

select * from clientes c
join reservas r on c.cliente_id = r.cliente_id
where c.nome = 'Luana Moura';